CREATE OR REPLACE PACKAGE BODY Tipologie AS
...
begin
    ...
    modGUI1.Header;
		...
		if hasRole(idSessione, 'DBA') or hasRole(idSessione, 'AB') or hasRole(idSessione, 'GM') or hasRole(idSessione, 'GCE') then
            ...
            htp.print('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;');
            modGUI1.Collegamento('Statistiche','StatisticheTipologieIng','w3-btn w3-round-xxlarge w3-black');
		end if;
                ...
                modGUI1.ApriDiv('class="w3-col l4 w3-padding-large w3-center"');
                    modGUI1.ApriDiv('class="w3-card-4" style="height:200px;"');
						...
						modGUI1.Collegamento('Visualizza',
                            'VisualizzaDatiTitoloIng?tipologiaIngID='||tipologia.idTipologiaIng,
                            'w3-btn w3-round-xxlarge w3-black');
						htp.print('&nbsp;');	
                    if hasRole(idSessione, 'DBA') or hasRole(idSessione, 'AB') or hasRole(idSessione, 'GM') or hasRole(idSessione, 'GCE') then
						modGUI1.Collegamento('Modifica',
                            'ModificaDatiTitoloIng?tipologiaIngID='||tipologia.idTipologiaIng,
                            'w3-btn w3-round-xxlarge w3-black');
						htp.print('&nbsp;');	
                        modGUI1.Collegamento('Elimina',
                            'CancellazioneTipologiaIng?tipologiaIngID='||tipologia.idTipologiaIng,
                            'w3-btn w3-round-xxlarge w3-black',
...
BEGIN
	...
	MODGUI1.ApriForm('ConfermaTipologiaIng');
	...
	MODGUI1.ChiudiForm;
	MODGUI1.collegamento('Annulla','ListaTipologieIng','w3-button w3-block w3-black w3-section w3-padding');
...
BEGIN
	...
	ELSE
        ...
        MODGUI1.ApriForm('InserisciDatiTipologieIng');
		...
		MODGUI1.ChiudiForm;
		MODGUI1.Collegamento('Annulla', 'InserisciTipologiaIng', 'w3-button w3-block w3-black w3-section w3-padding');
		MODGUI1.ChiudiDiv;
		HTP.BodyClose;
		HTP.HtmlClose;
	END IF;
...
BEGIN
	...
	THEN
		...
		HTP.tableClose;
		if hasRole(idSessione, 'DBA') or hasRole(idSessione, 'AB') or hasRole(idSessione, 'GM') or hasRole(idSessione, 'GCE') then
			MODGUI1.Collegamento('Modifica', 'ModificaDatiTitoloIng?&tipologiaIngID=' || tipologiaIngID, 'w3-btn w3-round-xxlarge w3-black');
			htp.print('&nbsp;');
			if Eliminato = 0
			then
				MODGUI1.Collegamento('Elimina',
					'CancellazioneTipologiaIng?&tipologiaIngID='||tipologiaIngID,
					'w3-btn w3-round-xxlarge w3-black',
...
BEGIN
	...
	THEN
		...
		MODGUI1.ApriForm('ConfermaModificaTipologiaIng');
		...
		if RipristinaEliminato > 0 then
			MODGUI1.collegamento('Annulla','VisualizzaTipologieEliminate','w3-button w3-block w3-black w3-section w3-padding');
		else	
			MODGUI1.collegamento('Annulla','ListaTipologieIng','w3-button w3-block w3-black w3-section w3-padding');
		end if;
...
BEGIN
	...
	ELSE
        ...
        MODGUI1.ApriForm('ModificaDatiTipologieIng');
		...
		MODGUI1.InputSubmit('Conferma');
		MODGUI1.ChiudiForm;
		MODGUI1.Collegamento('Annulla', 'ModificaDatiTitoloIng?tipologiaIngID='||IdTipologiaIng,'w3-button w3-block w3-black w3-section w3-padding');
		MODGUI1.ChiudiDiv;
		HTP.BodyClose;
		HTP.HtmlClose;
	END IF;
        ...
        htp.br;htp.br;htp.br;htp.br;htp.br;htp.br;
            modGUI1.ApriDiv('class="w3-modal-content w3-card-4 w3-animate-zoom w3-padding-large" style="max-width:450px"');
				...
				for x in countTitoli
						...
						modgui1.apriElementoTabella;
						modGUI1.Collegamento('Visualizza',
                            'VisualizzaDatiTitoloIng?tipologiaIngID='||x.idTipologiaIng,
                            'w3-btn w3-round-xxlarge w3-black');
						modgui1.chiudiElementoTabella;	
						modgui1.chiudiRigaTabella;
						end LOOP;
				modgui1.chiudiTabella;		
                MODGUI1.collegamento('Torna alle statistiche','StatisticheTipologieIng','w3-button w3-block w3-black w3-section w3-padding');
                modGUI1.ChiudiDiv;
            modGUI1.ChiudiDiv;
			HTP.BodyClose;
		HTP.HtmlClose;
...
begin
		MODGUI1.ApriPagina('Statistiche ambiente di servizio', idSessione);
			...
			modgui1.apriTabella('w3-table w3-striped w3-centered');
				...
				modgui1.apriRigaTabella;
					MODGUI1.ApriForm('TipologiaPiuScelta');
					modgui1.apriElementoTabella;
				...
				modgui1.apriRigaTabella;
					MODGUI1.ApriForm('VisualizzaTipologieIngOrdine');
					modgui1.apriElementoTabella;
						modgui1.apridiv('class="w3-padding-24"');
						modgui1.elementoTabella('Tutte le tipologie');
						modgui1.chiudiDiv;
				...
				modgui1.apriRigaTabella;
					MODGUI1.ApriForm('VisualizzaTipologieEliminate');
					modgui1.apriElementoTabella;
						modgui1.apridiv('class="w3-padding-24"');
						modgui1.elementoTabella('Tutte le tipologie');
						modgui1.chiudiDiv;
